...
public class ZipUtils {
	...
	public static java.util.List<java.io.File> GetFileList(
			String zipFileString, String des) throws Exception {
		...
		while ((zipEntry = inZip.getNextEntry()) != null) {
			...
			if (zipEntry.isDirectory()) {
				java.io.File folder = new java.io.File(des + "/" + szName);
				if (!folder.exists()) {
					folder.mkdirs();
				}
			}
	...
	public static void upZipFile(File zipFile, String folderPath)
		...
		for (Enumeration<?> entries = zf.entries(); entries.hasMoreElements();) {
			...
			String str = folderPath + File.separator + szName;
	...
	public static void UnZipFolder(String zipFileString, String outPathString)
		...
		while ((zipEntry = inZip.getNextEntry()) != null) {
			...
			if (zipEntry.isDirectory()) {
				...
				String path = outPathString + java.io.File.separator + szName;
